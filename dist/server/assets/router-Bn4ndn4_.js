import { V as reactExports, v as functionalUpdate$1, b as arraysEqual, h as createLRUCache, H as isPromise, I as isRedirect, G as isNotFound, B as invariant, g as createControlledPromise, a1 as rootRouteId, J as isServer$1, e as compileDecodeCharMap, a3 as trimPath, a0 as rewriteBasepath, f as composeRewrites, U as processRouteTree, S as processRouteMasks, $ as resolvePath, d as cleanPath, a5 as trimPathRight, Q as parseHref, q as executeRewriteInput, C as isDangerousProtocol, W as redirect, u as findSingleMatch, l as deepEqual, D as DEFAULT_PROTOCOL_ALLOWLIST, c as buildRouteBranch, A as interpolatePath, P as nullReplaceEqualDeep, Y as replaceEqualDeep$1, M as last, k as decodePath, s as findFlatMatch, t as findRouteMatch, z as hasKeys, r as executeRewriteOutput, n as encodePathLikeUrl, a4 as trimPathLeft, K as joinPaths, a7 as useRouter, m as dummyMatchContext, N as matchContext, x as getDefaultExportFromCjs, Z as requireReactDom, p as exactPathTest, X as removeTrailingSlash, R as React, L as jsxRuntimeExports, F as isModuleNotFoundError, a6 as useHydrated, o as escapeHtml, E as isInlinableStylesheet, w as getAssetCrossOrigin, _ as resolveManifestAssetLink, a as React$1, O as Outlet } from "./server-D8pWyu0D.js";
import { _ as __assign, a as __rest, b as __spreadArray, o as objectType, s as stringType, f as supabaseAdmin, g as getTransactionStatus, e as createPixCharge, Q as QRCode, c as arrayType, l as literalType, n as numberType } from "./paradise.server-DUvybL1E.js";
    ...
    (set, get) => ({
      ...
      add: (item) => set((s) => {
        ...
        if (existing) {
          return {
            items: s.items.map(
              (i) => i.id === item.id ? { ...i, qty: i.qty + item.qty } : i
            ),
            isOpen: true
          };
        }
...
const SheetContent = reactExports.forwardRef(({ side = "right", className, children, ...props }, ref) => /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetPortal, { children: [
  ...
  /* @__PURE__ */ jsxRuntimeExports.jsxs(Content, { ref, className: cn$1(sheetVariants({ side }), className), ...props, children: [
...
function CartDrawer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Sheet, { open: isOpen, onOpenChange: (o) => o ? null : close(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetContent, { side: "right", className: "w-full sm:max-w-md flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SheetHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SheetTitle, { children: "Seu carrinho" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto -mx-6 px-6 py-4 space-y-3", children: [
      items.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground py-12 text-center", children: "Seu carrinho está vazio." }),
      items.map((i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 border-b pb-3", children: [
        i.image && /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: i.image, alt: i.name, className: "w-16 h-16 object-cover rounded" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium leading-tight truncate", children: i.name }),
          (i.variant || i.size) && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: [i.variant, i.size].filter(Boolean).join(" • ") }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold", children: formatBRL(i.price * i.qty) })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => remove(i.id), "aria-label": "Remover", className: "self-start", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "w-4 h-4 text-muted-foreground" }) })
      ] }, i.id))
    ] }),
    items.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t pt-4 space-y-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-emerald-600", children: "Frete grátis aplicado no checkout" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { asChild: true, className: "w-full h-12 text-base bg-emerald-600 hover:bg-emerald-700", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/checkout", onClick: close, children: "Finalizar compra" }) })
    ] })
  ] }) });
}
...
const appCss = "/assets/styles-CVZDBSDv.css";
...
const Route$7 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Perfect Mirror Offer clones digital product offers with absolute fidelity, replicating design, copy, and functionality." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Perfect Mirror Offer clones digital product offers with absolute fidelity, replicating design, copy, and functionality." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Lovable App" },
      { name: "twitter:description", content: "Perfect Mirror Offer clones digital product offers with absolute fidelity, replicating design, copy, and functionality." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/b78e9200-06bd-4767-87a6-1044e36ca6a5/id-preview-05f784b2--dbf69930-dd6b-4862-ac9f-810796cd7693.lovable.app-1778551739340.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/b78e9200-06bd-4767-87a6-1044e36ca6a5/id-preview-05f784b2--dbf69930-dd6b-4862-ac9f-810796cd7693.lovable.app-1778551739340.png" }
    ],
    links: [
      {
        rel: "stylesheet",
...
const $$splitComponentImporter$3 = () => import("./obrigado-BpMDrycn.js");
const Route$6 = createFileRoute("/obrigado")({
  validateSearch: objectType({
    t: stringType().optional()
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component"),
  head: () => ({
    meta: [{
      title: "Obrigado pela compra | CS Capacetes"
    }]
  })
});
const $$splitComponentImporter$2 = () => import("./checkout-Ce3yfrHL.js");
const Route$5 = createFileRoute("/checkout")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component"),
  head: () => ({
    meta: [{
      title: "Resumo do pedido | CS Capacetes"
    }]
  })
});
const $$splitComponentImporter$1 = () => import("./index-CFGLKe5T.js");
const Route$4 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Capacete NORISK Soul II Grand Prix por R$ 62,00 com frete grátis. Oferta relâmpago por tempo limitado."
    }]
  })
});
const $$splitComponentImporter = () => import("./pix._transactionId-CJlQG7iJ.js");
const Route$3 = createFileRoute("/pix/$transactionId")({
...
const Route$2 = createFileRoute("/api/public/paradise-webhook")({
  server: {
    handlers: {
      POST: async ({ request }) => {
        ...
        const txId = payload?.data?.id ?? payload?.transaction?.id ?? payload?.id ?? payload?.transactionId ?? null;
        const rawStatus = payload?.data?.status ?? payload?.transaction?.status ?? payload?.status ?? "";
        if (!txId) {
...
const Schema = objectType({ transactionId: stringType().min(1).max(120) });
...
const Route$1 = createFileRoute("/api/public/order-status")({
  server: {
    handlers: {
      ...
      POST: async ({ request }) => {
        try {
          ...
          if (error || !order) {
            return jsonResponse$1({ error: "Pedido não encontrado" }, 404);
          }
...
const Route2 = createFileRoute("/api/public/create-pix")({
  server: {
    handlers: {
...
const ObrigadoRoute = Route$6.update({
  id: "/obrigado",
  path: "/obrigado",
...
const PixTransactionIdRoute = Route$3.update({
  id: "/pix/$transactionId",
  path: "/pix/$transactionId",
  getParentRoute: () => Route$7
});
const ApiPublicParadiseWebhookRoute = Route$2.update({
  id: "/api/public/paradise-webhook",
  path: "/api/public/paradise-webhook",
  getParentRoute: () => Route$7
});
const ApiPublicOrderStatusRoute = Route$1.update({
  id: "/api/public/order-status",
  path: "/api/public/order-status",
  getParentRoute: () => Route$7
});
const ApiPublicCreatePixRoute = Route2.update({
...
const rootRouteChildren = {
  ...
  CheckoutRoute,
  ObrigadoRoute,
  PixTransactionIdRoute,
  ApiPublicCreatePixRoute,
  ApiPublicOrderStatusRoute,
  ApiPublicParadiseWebhookRoute
};
